...
## Redcap 合规整改（2026-02-26）

- **状态**：✅ 已完成
- **整改内容**：
  1. 目录结构调整：`开发文档` → `开发手册`
  2. 文件重命名：`技术栈选型方案.md` → `2.技术栈选型.md`，`技术框架设计.md` → `3.技术框架设计.md`，`API接口文档.md` → `4.API接口文档.md`，`开发进度日志.md` → `5.开发进度日志.md`
  3. 新建 `1.需求文档.md`，记录经确认的完整需求
  4. `SECURITY.md` 安全检查清单更新为已勾选
- **Git Commit**：待与第四步一并提交，需经「通过」确认后执行
